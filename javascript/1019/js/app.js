...
for(let i = 0; i < 3; i++) {
    candies[i] = [];
    candies[i][0] = window.prompt(`Iveskite ${i+1} saldainio pavadinima:`);
    candies[i][1] = window.prompt(`Iveskite ${i+1} saldainio kaina:`);
    candies[i][2] = window.prompt(`Iveskite ${i+1} saldainio svori:`);
}
